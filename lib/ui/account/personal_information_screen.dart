...
import 'package:matlob/ui/account/edit_password_screen.dart';
import 'package:matlob/ui/account/edit_personal_info_screen.dart';
...
class _PersonalInformationScreenState extends State<PersonalInformationScreen> {
 ...
 void _defaultImageCLick() async {
   ...
   final results = await _apiProvider
       .postWithDio("https://nl-arabmarkt.com/api/default_photo"+ "?api_lang=${_authProvider.currentLang}", body: formData);
   setState(() => _isLoading = false);
               ...
               Positioned(
                 ...
                 child:  GestureDetector(
                   onTap: () async{
                       ...
                       final results = await _apiProvider
                           .post("https://nl-arabmarkt.com/api/default_photo/", body: {
                         "user_id": _authProvider.currentUser.userId,
                       });
    ...
    Consumer<AuthProvider>(
      ...
      builder: (context,authProvider,child){
          ...
          _authProvider.currentUser.userType=="2"?Consumer<AuthProvider>(
              builder: (context,authProvider,child){
                return     _buildItem(title: _authProvider.currentLang=="ar"?"المهنة":"Job",value: authProvider.currentUser.userJob)
                ;}):Text(""),


          _authProvider.currentUser.userType=="2"?Consumer<AuthProvider>(
              builder: (context,authProvider,child){
                return     _buildItem(title: _authProvider.currentLang=="ar"?"وصف تسويقي":"Marketing description",value: authProvider.currentUser.userWasf)
                ;}):Text(""),
